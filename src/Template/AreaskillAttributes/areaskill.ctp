...
<?= $this->Form->create($areaskill) ?>
<?php echo $this->Form->hidden('nursing_id', array('value' => $wee3))?>

<p align="justify">
<label>
<span> Student Name: </span>
<?php echo $this->Form->input('Attribute_Name', array('value' => $wee,'readonly'=>'readonly','label'=>'Student Name: ','style'=>'width:200px; border:none; background:transparent;'))?></label>
<label>
<span>Student No: </span>
<?php echo $this->Form->input('Attribute_No', array('value' => $wee2,'readonly'=>'readonly','label'=>'Student No: ', 'style'=>'width:200px; border:none; background:transparent;'))?></label></p>
...
<td>
  <select id="a1" onchange="changeFunc(); gTotal(); ">
...
<td>
  <select id='b1' onchange="changeFunc(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td>
  <select id='c1' onchange="changeFunc(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td>
  <select id='d1' onchange="changeFunc(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td>
  <select id='e1' onchange="changeFunc(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td align=center>
<?php echo $this->Form->input('Attribute_Score1',['id' => 'w1','readonly'=>'readonly','label'=>false])?>
</td>
</tr>
</table>
...
<?= $this->Form->create($areaskill2) ?>

<?php echo $this->Form->hidden('Attribute_Name', array('value' => $wee,'readonly'=>'readonly','label'=>'Name:','style'=>'width:300px; border:none; background:transparent;'))?>
<?php echo $this->Form->hidden('Attribute_No', array('value' => $wee2,'readonly'=>'readonly','label'=>'Student Id:', 'style'=>'width:200px; border:none; background:transparent;'))?></p>
...
<td align=center>
<select id='a2' onchange="changeFunc2(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
...
<td align=center>
<select id='b2' onchange="changeFunc2(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='c2' onchange="changeFunc2(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='d2' onchange="changeFunc2(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td align=center>
<select id='e2' onchange="changeFunc2(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td><strong>Weightage(%)</strong></td>
<td align=center>
   <?php echo $this->Form->input('Attribute_Score1',['id' => 'w2','readonly'=>'readonly','label'=>false]) ?>
</td>
</tr>
</table>
<?= $this->Form->button(__('Submit')) ?>
...
<td align=center>
<select id='a3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td align=center>
<select id='b3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td align=center>
<select id='c3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='d3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
</td>
</tr>
...
<td align=center>
<select id='e3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='f3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='g3' onchange="changeFunc3(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td><strong>Weightage(%)</strong></td>
<td align=center>
    <input type="text" id="w3" value="0" size="2" readonly/>
</td>
</tr>
</table>
...
<td align=center>
<select id='a4' onchange="changeFunc4(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
...
<td align=center>
<select id='b4' onchange="changeFunc4(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='c4' onchange="changeFunc4(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='d4' onchange="changeFunc4(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='e4' onchange="changeFunc4(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td><strong>Weightage(%)</strong></td>
<th align=center>
    <input type="text" id="w4" value="0" size="2" readonly/>
</th>
</tr>
</table>
<button onclick="">Submit</button>
...
<td align=center>
<select id='a5' onchange="changeFunc5(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='b5' onchange="changeFunc5(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td align=center>
<select id='c5' onchange="changeFunc5(); gTotal();">
  <option value="0">0</option>
  <option value="1">1</option>
  <option value="2">2</option>
</td>
...
<td><strong>Weightage(%)</strong></td>
<td align=center>
    <input type="text" id="w5" value="0" size="2" readonly/>
</td>
</tr>
</table>
<button onclick="">Submit</button>
...
<script type="text/javascript"> 
   ...
   function gTotal() 
  {
    var aSelect = document.getElementById('a1');
        ...
        var GrandTotal = weightage + weightage2 + weightage3 + weightage4 + weightage5; 
