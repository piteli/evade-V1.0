...
float: right;
font-size: 16px;"> <?= date('l, d M Y');?> &nbsp; <a href="login.html" class="btn btn-danger square-btn-adjust">Logout</a> </div>
        </nav>   
           <!-- /. NAV TOP  -->
            ...
            <div class="sidebar-collapse">
                ...
                <li class="text-center">
                    ...
                    <li>
                        <a  href="/users/lecturer"><i class="fa fa-dashboard fa-3x"></i> Dashboard</a>
                    </li>
                      <li>
