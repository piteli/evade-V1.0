...
<head>
	...
	<!-- BOOTSTRAP STYLES-->
   <?= $this->Html->css('/assets/css/bootstrap.css" rel="stylesheet" ) ?>
     <!-- FONTAWESOME STYLES-->
    <?= $this->Html->script('/assets/css/font-awesome.css" rel="stylesheet" ?>
     <!-- MORRIS CHART STYLES-->
    <?= $this->Html->css('/assets/js/morris/morris-0.4.3.min.css" rel="stylesheet" ?>
        <!-- CUSTOM STYLES-->
   <?= $this->Html->script('/assets/css/custom.css" rel="stylesheet" ?>
     <!-- GOOGLE FONTS-->
  <?= $this->Html->script('http://fonts.googleapis.com/css?family=Open+Sans' rel='stylesheet' type='text/css' ?>
</head>
<body>
    <div id="wrapper">
        <nav class="navbar navbar-default navbar-cls-top " role="navigation" style="margin-bottom: 0">
            <div class="navbar-header">
                ...
                <a class="navbar-brand" href="index.html">EVADE</a> 
            </div>
                ...
                <div class="row">
                    <div class="col-md-12">
                     <h2>Admin Dashboard</h2>   
                        <h5>Welcome  <a href="#"><?php echo $this->request->session()->read('Auth.User.fname'); ?>
        <?php echo $this->request->session()->read('Auth.User.lname'); ?> </a> </h5>
                    </div>
                </div>              
                 <!-- /. ROW  -->
                  <hr />
